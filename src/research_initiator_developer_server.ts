...
function refineQuestion(prompt: string, variables: string[]): string {
...
function generateHypotheses(prompt: string, variables: string[], references: string[]): string[] {
...
function createOperationalDefinitions(variables: string[], prompt: string): Record<string, any> {
...
function generateLiteratureReview(prompt: string, references: string[], variables: string[]): string {
  const review = `
